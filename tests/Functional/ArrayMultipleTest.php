...
use JuanchoSL\Validators\Types\Iterables\ArrayValidations;
use JuanchoSL\Validators\Types\Strings\StringValidations;
use PHPUnit\Framework\TestCase;

class ArrayMultipleTest extends TestCase
{
    ...
    {
        $this->validator = new ArrayValidations();
    }
...
$this->validator->isValueValidating((new ArrayValidations())->isKeyContainingAny(...['gorrion', 'golondrino']));
